  ...
  return (
    <section id="top" ref={ref} className="relative min-h-[100svh] pt-28 pb-16 md:pt-32 overflow-hidden bg-brand-cream">
      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-8 z-10">
        ...
        <h1 className="mt-6 font-hindi font-bold text-brand-indigo leading-[0.95] tracking-tight text-[46px] sm:text-[68px] md:text-[86px] lg:text-[112px]" data-testid="hero-headline">
